...
Define a pragmatic 0.7 release that improves day-to-day Amiga development workflow, interop safety, and compiler confidence without destabilizing the language.
...
- Changelog includes all user-visible behavior changes from 0.7 scope.
...
## Out of Scope for 0.7 (Recommended)
...
The rest of the 0.7 plan is compatible with either choice.
