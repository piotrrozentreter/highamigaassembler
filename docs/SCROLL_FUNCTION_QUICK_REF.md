...
✅ **Works in**: Mode 0, Mode 1 (16/4 color indexed), Mode 3 (dual playfield, active playfield only)  
❌ **Does NOT work in**: Mode 2 (HAM6)  
...
| Returns -1 | Graphics mode is HAM6 (mode 2) |
